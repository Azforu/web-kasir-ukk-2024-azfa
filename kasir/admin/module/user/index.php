									...
									<div class="panel-footer">
										<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
											...
											<span class="pull-right">
												<button type="submit"  class="btn btn-primary btn-sm" value="Tambah" onclick="javascript:return confirm('Ganti Foto Profil ?');"><i class="fa fa-pencil"> Ganti Foto</i></button>
											</span>
										</form>
										<br/>
										<br/>
											 ...
											 <form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?pass=ganti-pas">
												...
												<fieldset>
													...
													<div class="pull-right">															
														...
														<button type="submit" class="btn btn-primary" value="Tambah" style="border-radius:0px;" name="proses" onclick="javascript:return confirm('Ganti Username/password ?');"><i class="fa fa-pencil"></i> Ubah Password</button>
													</div>
												</fieldset>
											</form>
										</div>
